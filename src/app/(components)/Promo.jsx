        ...
        <div className="w-full bg-transparent p-4">
          <div className="promo-text relative top-20">
            ...
            <form className="flex items-center mt-4 w-full">
               <input placeholder="Email address..." type="email" required className=" bg-transparent border text-white outline-none p-2 text-sm w-4/5 md:w-3/5 rounded-md"/>
               <button className=" p-2 rounded-full ml-3 bg-emerald-400 hover:scale-75 duration-300  hover:bg-white"><MdArrowRight color="white" /></button>
            </form>
